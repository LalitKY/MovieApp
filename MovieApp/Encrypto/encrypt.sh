...
openssl enc -aes-256-ecb -md md5 -nosalt -in $PROJECT_DIR/MovieApp/Encrypto/$env_file_name.plist -out $TARGET_BUILD_DIR/$UNLOCALIZED_RESOURCES_FOLDER_PATH/$env_file_name.enc -K $file_key
